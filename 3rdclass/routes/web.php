...
Route::get ('/get/{id?}/{name?}/{dob?}',[StudentController::class,'get'])->name('student/get');//1st step.need to change to accept dynamic value while serching from navigation bar..2nd step on studentscontroller
Route::get('/students/list',[StudentController::class,'list'])->name('studentslist');